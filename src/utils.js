...
/**
 * turn time in minutes to milliseconds
...
/**
 * show milliseconds in minutes
 * @param {Number} ms time in milliseconds  
 * @returns {String} String of time in minutes
 */
export function MSToMinString(ms) {
    return (ms / 60 / 1000).toString(10);
}

/**
 * show milliseconds in seconds
 * @param {Number} ms time in milliseconds
 * @returns {String} String of time in seconds
 */
export function MSToSecString(ms) {
    return (ms / 1000).toString(10);
}
